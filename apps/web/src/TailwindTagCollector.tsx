...
export const TailwindTagCollector = () => {
  return (
    <div className="hidden">
      ...
      <div className="text-xs text-gray w-full flex items-center gap-3 p-3 hover:bg-gray-700 rounded-lg transition-colors" />
      ...
      {/* pool status */}
      <div className=" bg-gray-700 rounded-lg p-3 grid grid-cols-2 gap-4 flex justify-between items-center mb-4 w-full max-w-4xl mx-auto bg-gray-900 rounded-2xl shadow-xl p-6 text-white cursor-pointer" />
