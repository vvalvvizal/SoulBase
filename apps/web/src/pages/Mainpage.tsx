...
import { ArrowRight, Award, BarChart2, ChevronRight, Coins, CurrencyIcon as Exchange, ExternalLink, Star, TrendingUp, Trophy, Users } from 'lucide-react'
...
export default function Mainpage() {
  ...
  const featuredPlayers = [
    { id: 1, name: "김현수", team: "LG 트윈스", position: "외야수", achievements: ["홈런왕", "타율왕"], image: "/placeholder.svg?height=300&width=200" },
    { id: 2, name: "양현종", team: "KIA 타이거즈", position: "투수", achievements: ["다승왕", "평균자책점왕"], image: "/placeholder.svg?height=300&width=200" },
    { id: 3, name: "이정후", team: "키움 히어로즈", position: "외야수", achievements: ["도루왕", "안타왕"], image: "/placeholder.svg?height=300&width=200" },
  ]
  ...
  return (
    <div className="min-h-screen bg-gray-900 text-white">
        ...
        <div className="container mx-auto px-4 py-24 relative z-10">
          <div className="max-w-3xl">
            ...
            <p className="text-xl md:text-2xl text-gray-300 mb-8">
              SoulBase에서 야구 선수 업적 SBT를 응원하고 BBT 토큰으로 보상받으세요.
              유동성 풀에 참여하여 수익을 창출하세요.
            </p>
            <div className="flex flex-wrap gap-4">
              ...
              <Button size="small" className="border-blue-500 text-blue-400 hover:bg-blue-950">
                유동성 풀 참여하기
                <ChevronRight className="ml-2 h-4 w-4" />
              </Button>
            </div>
      ...
      <section className="py-20">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold mb-4">야구 선수 업적 SBT</h2>
            <p className="text-xl text-gray-400 max-w-2xl mx-auto">
              선수들의 특별한 업적을 기념하는 소울바운드 토큰(SBT)을 수집하고 소유하세요.
              각 SBT는 고유하며 양도할 수 없습니다.
            </p>
          </div>
          ...
          <div defaultValue="all" className="mb-12">
            ...
            <div>
              <div className="text-center py-12">
                <p className="text-gray-400">타자 업적 SBT를 보려면 로그인하세요</p>
              </div>
            </div>
            ...
            <div>
              <div className="text-center py-12">
                <p className="text-gray-400">투수 업적 SBT를 보려면 로그인하세요</p>
              </div>
            </div>
            ...
            <div>
              <div className="text-center py-12">
                <p className="text-gray-400">특별 업적 SBT를 보려면 로그인하세요</p>
              </div>
            </div>
          </div>
          ...
          <div className="flex flex-col md:flex-row items-center gap-12">
            <div className="md:w-1/2">
              ...
              <p className="text-xl text-gray-300 mb-6">
                BBT 토큰은 SoulBase 생태계의 핵심 화폐입니다. SBT 수집, 스테이킹, 거버넌스 참여 등 다양한 활동에 사용됩니다.
              </p>
              <div className="space-y-4 mb-8">
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400">SBT를 수집하면 BBT 토큰으로 보상받을 수 있습니다.</p>
                  </div>
                </div>
                <div className="flex items-start">
                  <div className="bg-blue-900 p-2 rounded-lg mr-4 mt-1">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400">BBT 토큰을 스테이킹하여 추가 수익을 창출하세요.</p>
                  </div>
                </div>
                <div className="flex items-start">
                  <div className="bg-blue-900 p-2 rounded-lg mr-4 mt-1">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400">BBT 토큰 보유자는 플랫폼의 중요한 결정에 투표할 수 있습니다.</p>
                  </div>
                </div>
              </div>
            ...
            <div className="md:w-1/2">
                  ...
                  <div className="space-y-4 mb-6">
                    ...
                    <div className="flex justify-between py-2">
                      ...
                      <span className="font-medium text-blue-400">0x1a2b...3c4d</span>
                    </div>
                  </div>
      ...
      <section className="py-20">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold mb-4">BBT-POL 유동성 풀</h2>
            <p className="text-xl text-gray-400 max-w-2xl mx-auto">
              BBT와 POL 토큰을 교환하고 유동성 풀에 참여하여 수수료 수익을 얻으세요.
            </p>
          </div>
           ...
           <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
            <div className="bg-gray-800 border-gray-700">
              <div className="p-6">
                ...
                <p className="text-gray-400 mb-6">
                  BBT와 POL 토큰을 쉽고 빠르게 교환하세요. 낮은 수수료와 슬리피지로 최적의 거래를 제공합니다.
                </p>
            ...
            <div  className="bg-gray-800 border-gray-700">
              <div className="p-6">
                ...
                <p className="text-gray-400 mb-6">
                  BBT와 POL 토큰을 유동성 풀에 제공하고 거래 수수료의 일부를 수익으로 받으세요.
                </p>
                <Button className="w-full bg-blue-600 hover:bg-blue-700">
                  유동성 추가하기
                </Button>
            ...
            <div className="bg-gray-800 border-gray-700">
              <div className="p-6">
                ...
                <p className="text-gray-400 mb-6">
                  유동성 풀 참여로 얻은 수익을 확인하고 보상을 청구하세요. 실시간으로 수익을 추적할 수 있습니다.
                </p>
                <Button className="w-full bg-blue-600 hover:bg-blue-700">
                  수익 확인하기
                </Button>
      ...
      <section className="py-20 bg-gradient-to-r from-blue-900 to-purple-900">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-3xl md:text-4xl font-bold mb-6">SoulBase에 참여하세요</h2>
          <p className="text-xl text-gray-300 mb-8 max-w-2xl mx-auto">
            야구 선수 업적 SBT를 수집하고, BBT 토큰으로 보상받고, 유동성 풀에 참여하여 수익을 창출하세요.
          </p>
          <Button size="small" className="bg-white text-blue-900 hover:bg-gray-200">
            지금 시작하기
            <ChevronRight className="ml-2 h-4 w-4" />
          </Button>
        </div>
