...
export const SBTItem = () => {
 ...
 const {SBT} = data || {};
 const {id, name, description, image_url, tokenId, metadataJSON_url} = SBT || {};

  return (<div className="max-w-md mx-auto bg-white rounded-xl shadow-md overflow-hidden md:max-w-2xl border border-gray-200">
    <div className="md:flex">
      ...
      <div className="p-8">
        <div className="flex items-center">
          ...
          <div className="uppercase tracking-wide text-sm text-indigo-500 font-semibold">SBT #{tokenId}</div>
        </div>
